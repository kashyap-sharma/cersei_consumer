...
public class ButtonModarno extends Button {


    public ButtonModarno(Context context) {
        super(context);
        if(isInEditMode())
        {
            return;
    ...
    public ButtonModarno(Context context, AttributeSet attrs) {
        super(context, attrs);
        Typeface tf;
    ...
    public ButtonModarno(Context context, AttributeSet attrs, int defStyle) {
