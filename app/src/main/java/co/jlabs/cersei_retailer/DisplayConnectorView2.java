...
public final class DisplayConnectorView2 extends View {
    ...
    static {
        ...
        clearPaint.setColor(BlockCanaryUi.ROOT_COLOR);
    ...
    public DisplayConnectorView2(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//        int height = getHeight();
        ...
        if (cache == null) {
            ...
            float halfWidth = (4/3)*width / 2f;
            float halfHeight = height / 2f;
            float thirdWidth = (4/3)*width / 3f;
