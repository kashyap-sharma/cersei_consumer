package co.jlabs.cersei_retailer.RoundCornerProgressBar.common;
...
/**
 * Created by Kashyap on 03/01/16.
 */
public abstract class BaseRoundCornerProgressBar extends LinearLayout {
    ...
    public void setupStyleable(Context context, AttributeSet attrs) {
        ...
        colorSecondaryProgress = typedArray.getColor(
                R.styleable.RoundCornerProgress_rcSecondaryProgressColor, colorSecondaryProgressDefault);
        typedArray.recycle();
