package co.jlabs.cersei_retailer.StepView;
...
public class HorizontalStepsViewIndicator extends View
{
    ...
    private int mUnCompletedLineColor = ContextCompat.getColor(getContext(), R.color.black);//定义默认未完成线的颜色  definition
    ...
    private void init()
    {
        ...
        mCompleteIcon = ContextCompat.getDrawable(getContext(), R.drawable.success);//已经完成的icon
        mAttentionIcon = ContextCompat.getDrawable(getContext(),R.drawable.success_done);//正在进行的icon
